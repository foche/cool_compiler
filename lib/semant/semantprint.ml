...
let print_location (startpos, endpos) =
  ...
  let offset1 = startpos.pos_bol in
  let offset2 = endpos.pos_bol in
  if line1 = line2
  then Printf.eprintf "line %d, characters %d-%d:\n" line1 offset1 offset2
  else Printf.eprintf "line %d, character %d to line %d, character %d\n" line1 line2 offset1 offset2
