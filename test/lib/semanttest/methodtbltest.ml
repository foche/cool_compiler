...
let%test "Duplicate add" =
  ...
  && Methodtbl.add tbl ~cl_typ:Tutil.cl_a ~method_id:foo_method
       ~method_ret_typ:Tutil.cl_b ~formals:[ (x, Tables.bool_type) ]
     |> not
  && Methodtbl.add tbl ~cl_typ:Tutil.cl_b ~method_id:foo_method
       ~method_ret_typ:Tables.int_type ~formals:[]
...
let%test "find_opt" =
  ...
  let cl_a_foo_sig =
    {
      Methodtbl.method_ret_typ = Tutil.cl_b;
      formals;
  ...
  && Methodtbl.add tbl ~cl_typ:Tutil.cl_b ~method_id:bar_method
       ~method_ret_typ:Tables.int_type ~formals
  ...
  && Methodtbl.find_opt tbl ~inherit_tree:Treeutil.tree ~cl_typ:Tutil.cl_d
       ~method_id:foo_method
     = Some cl_c_foo_sig
  && Methodtbl.find_opt tbl ~inherit_tree:Treeutil.tree ~cl_typ:Tutil.cl_a
       ~method_id:foo_method
     = Some cl_a_foo_sig
  && Methodtbl.find_opt tbl ~inherit_tree:Treeutil.tree ~cl_typ:Tutil.cl_a
       ~method_id:bar_method
     = None
  && Methodtbl.find_opt tbl ~inherit_tree:Treeutil.tree ~cl_typ:Tutil.cl_b
       ~method_id:foo_method
     = Some cl_a_foo_sig
