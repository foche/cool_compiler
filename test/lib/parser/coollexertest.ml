...
let%test _ =
  assert_equal_token "\"\\\"\\0\\\\0\\f\\\\f\"" (STR_CONST "\"0\\0\012\\f")
...
let%test _ =
  assert_equal_token "\" (* 123 -- *) \"" (STR_CONST " (* 123 -- *) ")
...
let%test _ =
  assert_equal_token
    (stringify (long_str_a ^ "a"))
    (ERR "String constant too long")
...
let%test _ =
  assert_equal_token (stringify long_esc_str) (STR_CONST long_esc_str_res)

let%test _ =
  assert_equal_token
    (stringify (long_esc_str ^ "a"))
    (ERR "String constant too long")
